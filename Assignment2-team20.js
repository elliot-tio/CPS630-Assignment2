...
function invoice(){
  ...
  fullPrice="$" + fullPrice.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,');
  artPrice="$" + artPrice.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,');
  curTax="$" + curTax.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, '$1,');
